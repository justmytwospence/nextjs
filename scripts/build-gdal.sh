...
"$CONDA_DIR"/bin/conda run -n gdal_env cmake .. \
  ...
  -DCMAKE_CXX_FLAGS="-nostdlib -D_GNU_SOURCE -I$CONDA_DIR/envs/gdal_env/include -L$CONDA_DIR/envs/gdal_env/lib" \
  -DCMAKE_C_FLAGS="-nostdlib -D_GNU_SOURCE -I$CONDA_DIR/envs/gdal_env/include -L$CONDA_DIR/envs/gdal_env/lib" \
